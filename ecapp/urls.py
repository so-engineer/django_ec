...
from .views import (
    ...
    ItemDetail,
    ItemList,
    add_to_cart_from_detail_func,
    add_to_cart_from_list_func,
    cart_func,
...
urlpatterns = [
    ...
    path(
        "checkout/add_list/<int:pk>",
        add_to_cart_from_list_func,
        name="checkout_add_list",
    ),
    path(
        "checkout/add_detail/<int:pk>",
        add_to_cart_from_detail_func,
        name="checkout_add_detail",
    ),
    ...
    path(
        "adm/items/create/",
        basic_auth_required(AdmItemCreate.as_view()),
        name="adm_create",
    ),
    path(
        "adm/items/update/<int:pk>",
        basic_auth_required(AdmItemUpdate.as_view()),
        name="adm_update",
    ),
    path(
        "adm/items/delete/<int:pk>",
        basic_auth_required(AdmItemDelete.as_view()),
        name="adm_delete",
    ),
    path("adm/bills/", basic_auth_required(AdmBuyList.as_view()), name="adm_buy_list"),
    path(
        "adm/bills/<int:pk>/items/",
        basic_auth_required(AdmBuyDetail.as_view()),
        name="adm_buy_detail",
    ),
]
